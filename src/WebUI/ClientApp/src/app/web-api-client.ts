...
export class TodoListsClient implements ITodoListsClient {
     ...
     */
    delete(id: number): Observable<FileResponse> {
        let url_ = this.baseUrl + "/todolists/{id}";
...
export interface ITodoItemsClient {
     ...
     * Creates a Todo Item
     */
    create(request: CreateTodoItemCommand): Observable<number>;
    /**
     * Deletes a Todo Item
     */
    delete(id: number): Observable<FileResponse>;
     ...
     * Gets a Todo Item
     */
    getTodoItemsWithPagination(request: GetTodoItemsWithPaginationQuery): Observable<PaginatedListOfTodoItemBriefDto>;
    /**
...
export class TodoItemsClient implements ITodoItemsClient {
     ...
     */
    create(request: CreateTodoItemCommand): Observable<number> {
        let url_ = this.baseUrl + "/todoitems";
        url_ = url_.replace(/[?&]$/, "");
     ...
     */
    delete(id: number): Observable<FileResponse> {
        let url_ = this.baseUrl + "/todoitems/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
     ...
     */
    getTodoItemsWithPagination(request: GetTodoItemsWithPaginationQuery): Observable<PaginatedListOfTodoItemBriefDto> {
        let url_ = this.baseUrl + "/todoitems/GetTodoItemsWithPagination";
        url_ = url_.replace(/[?&]$/, "");
